    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function tampil_data_barang() {
                $.ajax({
                    type: 'GET',
                    url: '<?php echo base_url() ?>produk/data_barang',
                    async: true,
                    dataType: 'json',
            ...
            $('#show_data').on('click', '.item_edit', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<?php echo base_url('Produk/get_barang') ?>",
                    dataType: "JSON",
                    data: {
                        id: id
                    },
                    success: function(data) {
                        $.each(data, function(barang_kode, barang_nama, barang_harga) {
                            ...
                            $('[name="harga_edit"]').val(data.harga_barang);
                        });
                    }
                });
                return false;
            ...
            $('#btn_simpan').on('click', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('Produk/simpan_barang') ?>",
                    dataType: "JSON",
                    data: {
                        kobar: kobar,
                        nabar: nabar,
            ...
            $('#btn_update').on('click', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('Produk/update_barang') ?>",
                    dataType: "JSON",
                    data: {
                        kobar: kobar,
                        nabar: nabar,
            ...
            $('#btn_hapus').on('click', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('Produk/hapus_barang') ?>",
                    dataType: "JSON",
                    data: {
                        kode: kode
                    },
